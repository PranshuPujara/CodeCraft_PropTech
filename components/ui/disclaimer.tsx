export function Disclaimer({ text, className = '' }: { text?: string; className?: string }) {
  return (
    <p className={`rounded-xl border border-amber-200 bg-amber-50 px-3 py-2.5 text-[13px] leading-relaxed text-amber-900 dark:border-amber-800/40 dark:bg-amber-950/40 dark:text-amber-300 ${className}`}>
